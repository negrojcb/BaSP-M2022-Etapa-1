...
var spirits = ["gin", "vodka", "ron", "whisky", "tequila"];
for (var i = 0; i <= spirits.length - 1; i++) {alert(spirits[i]);}
...
for (var i = 0; i <= spirits.length - 1; i++) {
    alert(spirits[i].substring(0,1).toUpperCase() + spirits[i].substring(1));
}
...
var sentence = " ";
for (var i = 0; i <= spirits.length - 1; i++) {sentence = spirits.join('');}
alert(sentence);
